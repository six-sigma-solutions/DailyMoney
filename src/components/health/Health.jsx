  ...
  return (
    ...
    <div className="health-heading">
      ...
      <footer id="footer" className="footer">
        ...
        <div>
       <h1 className="tamil"> "தண்ணீரைச் சாப்பிடு, உணவை அருந்து" <br /> "உண்மையான   வாழ்க்கையின் ரகசியம் <span style={{background:"blue", fontSize:"32px", borderRadius: "5px", padding: "5px", margin: "5px"}}> ஆரோக்கியம்."</span></h1>
