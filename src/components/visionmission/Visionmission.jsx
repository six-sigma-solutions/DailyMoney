  ...
  return (
    <main className="dm-vsn-main-content">
          ...
          <div className="dm-vsn-card-overlay">
            <div className="dm-vsn-card-text">
              ...
              <p className="dm-vsn-lead">
                A brighter world — healthy in spirit, joyful in living, and
                abundant in growth.<br></br>
                Living in flow with nature — where wellness nourishes wealth,
                and joy sustains growth.<br></br>
                Building a future where vitality, happiness, and financial
                freedom flow as one.<br></br>
            ...
            <div className="vision-col vision-text-col">
              <h2>
                <div className="vision-paragraph-container">
                  <p style={{ color: "red", marginRight: "15px" }}>✔️</p>
                  <p>
                    {" "}
                    Transforming the way the world lives — healthier in body,
                    happier in heart, and richer in spirit.
                  </p>
                </div>
                ...
                <div className="vision-paragraph-container">
                  <p style={{ color: "red", marginRight: "15px" }}>✔️</p>{" "}
                  <p>
                    To inspire a world where well-being, joy, and prosperity
                    thrive together.
                  </p>
                </div>
              </h2>
            ...
            <div className="vision-col vision-text-col">
              <h2>
                <div className="vision-paragraph-container">
                  <p style={{ color: "red", marginRight: "15px" }}>✔️</p>{" "}
                  <p>
                    To nurture global wellness and wealth through mindful living
                    and empowered growth.
                  </p>
                </div>
                ...
                <div className="vision-paragraph-container">
                  <p style={{ color: "red", marginRight: "15px" }}>✔️</p>{" "}
                  <p>
                    To harmonize body, mind, and prosperity through conscious,
            ...
            <div className="vision-col vision-text-col">
              <h2>
                <div className="vision-paragraph-container">
                  <p style={{ color: "red", marginRight: "15px" }}>✔️</p>{" "}
                  <p>
                    A world of harmony — where health, happiness, and wealth
                    coexist in balance.
                  </p>
                </div>
                ...
                <div className="vision-paragraph-container">
                  ...
                  <p>
                    {" "}
                    To redefine success by aligning health, happiness, and
                    financial growth.
                  </p>
                </div>
              </h2>
            ...
            <div className="vision-col vision-text-col">
              <h2>
                <div className="vision-paragraph-container">
                  <p style={{ color: "red", marginRight: "15px" }}>✔️</p>{" "}
                  <p>
                    To create a global movement that connects well-being with
                    wealth-building for a better tomorrow.
                  </p>
                </div>
                ...
                <div className="vision-paragraph-container">
                  ...
                  <p>
                    {" "}
                    Empower every individual to live healthier, happier, and
                    more abundant lives through balance and purpose.
                  </p>
                </div>
              </h2>
            </div>
      ...
      <section className="dm-vsn-action-section">
        <button
          id="dm-vsn-solution-btn"
          className="dm-vsn-animated-btn"
